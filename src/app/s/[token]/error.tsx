      ...
      <main className="lexd-workbench flex-1 flex items-center justify-center p-4">
        <div className="text-center max-w-sm">
          ...
          <p className="text-sm text-[var(--text-secondary)] mb-6">
            Nous ne pouvons pas charger ce suivi pour le moment. Veuillez réessayer.
          </p>
          <button
            onClick={reset}
            className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#0277BD] text-white rounded-xl text-sm font-semibold hover:bg-[#01579B] transition-colors mb-8"
          >
          ...
          <div className="pt-6 border-t border-[var(--border)]">
            <p className="text-xs text-[var(--text-muted)] mb-3">Téléchargez l&apos;app pour un suivi optimal</p>
