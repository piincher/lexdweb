...
export async function generateHomeMetadata(locale: Locale): Promise<Metadata> {
  ...
  return generatePageMetadata({
    ...
    keywords: isEn
      ...
      : 'cargo chine cameroun, transitaire chine cameroun, fret chine douala, envoi colis chine cameroun, fret aerien chine afrique, conteneur chine cameroun, expedition chine cameroun, achat alibaba cameroun, agent sourcing chine, LEXD, fret maritime, fret aérien, expédition Chine, transitaire, logistique internationale, agent achat Alibaba, acheter sur 1688 Afrique, payer fournisseur chinois, vérifier fournisseur chinois, cargo aérien Chine Cameroun, conteneur maritime Chine Afrique, livraison porte à porte Chine Afrique, fret pas cher Chine Afrique, agent Alibaba Cameroun, agent sourcing 1688, paiement fournisseur Chine, audit usine Chine, importer textiles Chine, importer électronique Chine, importer machines Chine, importer cosmétiques Chine, importer pièces auto Chine, matériaux construction Chine Afrique, expédition Douala, transitaire Douala, commerce Chine Cameroun, logistique Afrique',
    path: '/',
    locale,
    ogType: 'website',
  });
